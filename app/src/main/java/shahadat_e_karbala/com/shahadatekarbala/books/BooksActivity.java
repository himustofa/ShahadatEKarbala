package shahadat_e_karbala.com.shahadatekarbala.books;
...
public class BooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar.setTitle(getResources().getString(R.string.books_title));

        myWebViewMain = (WebView) findViewById(R.id.books_web_view_id);
        startWebView("http://books.shahadat-e-karbala.com");
    }
