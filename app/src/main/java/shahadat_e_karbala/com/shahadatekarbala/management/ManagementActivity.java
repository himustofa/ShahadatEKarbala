package shahadat_e_karbala.com.shahadatekarbala.management;
...
public class ManagementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar.setTitle(getResources().getString(R.string.management_title));


        myWebViewMain = (WebView) findViewById(R.id.management_web_view_id);
        startWebView("http://shahadat-e-karbala.com/committee/");
    }
